...
///<reference path="./typings/angularjs/angular-modal-service.d.ts"/>
///<reference path="./typings/angular-ui-bootstrap/angular-ui-bootstrap.d.ts"/>

///<reference path="./interfaces/choreTemplate.ts"/>
///<reference path="./interfaces/choretemplatelist.ts"/>
///<reference path="./interfaces/chore.ts"/>
...
///<reference path="./code/services/choresDataSvc.ts" />
///<reference path="./code/services/userProfileSvc.ts" />

///<reference path="./code/controllers/appcontroller.ts"/>
///<reference path="./code/controllers/loginmodalctrl.ts"/>
